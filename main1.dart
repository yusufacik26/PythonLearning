...
class _CameraScreenState extends State<CameraScreen> {
  ...
  String _getColorNameFromHSV(int r, int g, int b) {
    ...
    if (saturation < 0.2) return "Gri";

    if (hue >= 0 && hue <= 20) return "Kırmızı";
    if (hue > 20 && hue <= 40) return "Turuncu";
    if (hue > 40 && hue <= 65) return "Sarı";
    if (hue > 65 && hue <= 170) return "Yeşil";
    if (hue > 170 && hue <= 260) return "Mavi";
    if (hue > 260 && hue <= 290) return "Mor";
    if (hue > 290 && hue <= 360) return "Pembe";
